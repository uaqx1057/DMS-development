...
<head>
    ...
    <title>Recharge Request - Speed Logistics</title>
...
<body>
    ...
    <div class="email-container">
        ...
        <h2>Request Recharge</h2>

        <p>
            A new recharge request has been submitted from <strong>{{ $superviserData->name ?? 'Operation Superviser' }}</strong>.
        ...
        <table class="details-table">
            ...
            <tr>
                <th>Requested By</th>
               <td>{{ $superviserData->name ?? 'N/A' }} ({{ $superviserData->role->name ?? 'N/A' }})</td>
            </tr>

        </table>

        <p>
            You can review this request in the Request Recharge dashboard
        </p>
