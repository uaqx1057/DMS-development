    ...
    <x-ui.row>
        <x-ui.col class="col-lg-12">
            ...
            <form wire:submit="create">
                ...
                <x-form.option value="" name="--select--"/>
                ...
                <x-ui.alert error="designation_id"/>
                    ...
                    <!-- Begin: Joining Card -->
                    <x-ui.col class="mb-3 col-lg-3 col-md-3">
                        <x-form.label for="joining_date" name="Joining Date" :required="true"/>
                    ...
                    <x-ui.col class="mb-3 col-lg-3 col-md-3">
                        <x-form.label for="reporting_to" name="Reporting To" :required="true"/>
                        <x-form.select class="form-select" id="reporting_to" wire:model='reporting_to'>
                            <x-form.option value="" selected name="--select--"/>
                ...
                <x-ui.card>
                    ...
                    <x-ui.row>
                        ...
                        <x-ui.col class="mb-3 col-lg-3 col-md-3">
                            <x-form.label for="probation_end_date" name="Probation End Date" :required="true"/>
                        ...
                        <x-ui.col class="mb-3 col-lg-3 col-md-3">
                            <x-form.label for="notice_period_start_date" name="Notice Period Start Date" :required="true"/>
                        ...
                        <x-ui.col class="mb-3 col-lg-3 col-md-3">
                            <x-form.label for="notice_period_end_date" name="Notice Period End Date" :required="true"/>
